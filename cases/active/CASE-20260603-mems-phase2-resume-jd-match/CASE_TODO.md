...
4. 授权执行后：`python3 scripts/render_handoff.py cases/active/CASE-20260603-mems-phase2-resume-jd-match`
5. 结案前：`python3 scripts/validate_case.py cases/active/CASE-20260603-mems-phase2-resume-jd-match`
